...
function Accordian() {
        ...
        const [btn, setBut] = useState("Enable Drark mood")
        const toggle=()=> {
            ...
            setBut("Enable dark mood")
                ...
                setBut("Enable Light mood")
            }
        }
    
    return (
        <>
        <div className="countainer" style={mystyle}>
            ...
            <button className="btn btn-primary btn" onClick={toggle} >{btn}</button></div>
            </div>
        </>
    )
}
